...
function createRenderer(renderOptions2) {
  ...
  const patchElement = (n1, n2) => {
    ...
    if (n2.dymanicChildren) {
      patchdynamicChildren1, n2);
    } else {
      patchChildren(n1, n2, el);
    }
  };
  function patchBlockChildren(n1, n2) {
    for (let i = 0; i < n2.dymanicChildren.length; i++) {
      patchElement(n1.dymandynamicChildrenn2.dymanicChildren[i]);
    } dynamicChildrendynamicChildren
  }
